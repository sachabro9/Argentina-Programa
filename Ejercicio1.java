...
public class Ejercicio1 {
	...
	public static void main(String[] args) {
		...
		Descuento desc3 = new DescuentoConTope();
		desc1.setValorDesc(150.0);
		desc2.setValorDesc(10.0);
		desc3.setValorDesc(10.0);
		...
		System.out.println("El precio con el descuento porcentual con tope es "+ desc3.valorFinal(total));
